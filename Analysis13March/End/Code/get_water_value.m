function water_pixel_value=get_water_value(fresh_img,background_img)
%% Extracting the location of channel.
%===================================================================================%
%  NOTE BEFORE USING: "img": END-Section image portion                                %
%===================================================================================%
...
%So it is necessaary to kepp the channel straight in the image
...
water_pixel_value=sum(sum(channel_matrix,1),2)./(m.*n);
