...
function mixing_index=mixing_index(avg_ref_val,max_deviation,min_deviation,img,background_img)
%===================================================================================%
%  NOTE BEFORE USING: "img": is last section image of outlet  or Y accord to use    %
%===================================================================================%
